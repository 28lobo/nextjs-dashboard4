...
export async function GET() {
  try {
    // 1️⃣ Create the extension once before any transactional operations
    await sql`CREATE EXTENSION IF NOT EXISTS "uuid-ossp";`;

    // 2️⃣ Seed all data within a single transaction
...
// Each seeder now accepts the tx instance and does NOT recreate the extension
